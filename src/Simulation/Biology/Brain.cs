...
/// <summary>
/// Provides neural network processing for agents in the simulation.
/// Handles sensory input processing, neural network inference, and action execution.
/// </summary>
public static class Brain
{
    /// <summary>
    /// Processes sensory inputs and runs neural network inference for an agent.
    /// Updates the agent's neuron activations based on sensors, genome, and instincts.
    /// </summary>
    /// <param name="agent">The agent to process.</param>
    /// <param name="gridMap">The simulation grid.</param>
    /// <param name="rng">Random number generator for stochastic behaviors.</param>
    /// <param name="agentPopulation">Array of all agents in the simulation.</param>
    ...
    /// <summary>
    /// Executes actions based on the brain's neural network output.
    /// Handles movement, attacks, reproduction, and other agent behaviors.
    /// </summary>
    /// <param name="agent">The agent to act.</param>
    /// <param name="gridMap">The simulation grid.</param>
    /// <param name="rng">Random number generator.</param>
    /// <param name="agentPopulationSpan">Span of all agents.</param>
    /// <param name="plantPopulationSpan">Span of all plants.</param>
