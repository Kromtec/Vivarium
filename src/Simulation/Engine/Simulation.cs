...
/// <summary>
/// Main simulation engine that manages the world, entities, and simulation loop.
/// </summary>
public class Simulation
{
    ...
    /// <summary>Maximum number of plants.</summary>
    public int PlantCount => ConfigProvider.World.PlantPoolSize;
    /// <summary>Maximum number of structures.</summary>
    public int StructureCount => ConfigProvider.World.StructurePoolSize;

    /// <summary>Array of all agents in the simulation.</summary>
    public Agent[] AgentPopulation { get; }
    /// <summary>Array of all plants in the simulation.</summary>
    public Plant[] PlantPopulation { get; }
    /// <summary>Array of all structures in the simulation.</summary>
    public Structure[] StructurePopulation { get; }
    /// <summary>2D grid mapping positions to entities.</summary>
    public GridCell[,] GridMap { get; }
    /// <summary>Random number generator for simulation.</summary>
    public Random Rng { get; }
    /// <summary>Number of simulation ticks elapsed.</summary>
    public long TickCount { get; private set; }

    /// <summary>Current number of alive agents.</summary>
    public int AliveAgents { get; private set; }
    /// <summary>Current number of alive plants.</summary>
    public int AlivePlants { get; private set; }
    /// <summary>Current number of alive structures.</summary>
    public int AliveStructures { get; private set; }

    /// <summary>Creates a new simulation instance.</summary>
    public Simulation()
    {
    ...
    /// <summary>
    /// Initializes the simulation by spawning the initial population.
    /// </summary>
    ...
    /// <summary>
    /// Runs one simulation tick, updating all agents and plants.
    /// </summary>
    public void Update()
    {
        TickCount++;
